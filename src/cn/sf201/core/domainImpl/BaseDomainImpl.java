...
import cn.sf201.core.exception.OperateException;
import cn.sf201.core.utils.Page;
import cn.sf201.core.utils.ReflectionUtils;
...
public abstract class BaseDomainImpl extends HibernateDaoSupport implements BaseDomain {
	...
	//为使用多数据库在此处设置sessionFactory，而不用autowired
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	public void merge(BaseObject entity){
