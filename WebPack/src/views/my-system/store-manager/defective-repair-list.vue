...
<script>
    ...
    export default {
        ...
        methods: {
            view(document) {
                this.$router.push({name: 'defectiveRepair', params: {documentNo: document.documentNo}});
            },
            getDefectiveList() {
                let vm = this;
                invokeSrv.getFnData(storeSrv.getDefectiveRepairMasterList, vm.query, function (data) {
